...
4. **Revisión de compatibilidad** — ¿El skill es compatible con derecho español? ¿Necesita adaptación jurisdiccional?
...
| Adaptación jurisdiccional | Alto | ¿Funciona con derecho español o solo con derecho anglosajón? |
...
work product" estadounidenses. En derecho español no existe esa doctrina. Al evaluar un skill, el
hub señala si la cabecera asume protección inexistente en España y recomienda usar
