...
| **Vigilante de expedientes judiciales** | Consulta el estado de expedientes en CENDOJ / LexNET / sedes judiciales y alerta ante cambios | [PLACEHOLDER] |
| **Monitor regulatorio** | Vigila el BOE, DOUE y boletines autonómicos en busca de normas relevantes para la práctica | [PLACEHOLDER] |
| **Radar de lanzamientos** | Detecta nuevas versiones de skills, plugins y herramientas legales relevantes | [PLACEHOLDER] |
| **Grid de due diligence** | Ejecuta checklists de due diligence recurrentes contra fuentes públicas (Registro Mercantil, BORME, CIRBE si autorizado) | [PLACEHOLDER] |
...
| Campo | Valor |
|---|---|
| Expedientes vigilados | [PLACEHOLDER — lista de números de procedimiento] |
| Fuentes | [PLACEHOLDER — LexNET, sede judicial electrónica, CENDOJ] |
| Frecuencia | [PLACEHOLDER — diaria / semanal] |
| Alerta ante | [PLACEHOLDER — nueva resolución, señalamiento, notificación] |

### Monitor regulatorio

| Campo | Valor |
|---|---|
| Fuentes | [PLACEHOLDER — BOE, DOUE, boletines autonómicos específicos] |
...
| Fuentes públicas | [PLACEHOLDER — Registro Mercantil, BORME, catastro, CIRBE] |
...
| LexNET / sedes judiciales | [PLACEHOLDER] | Consulta manual |
