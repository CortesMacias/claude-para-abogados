...
name: alertas
description: >
  Alertas regulatorias (agente programado) — monitoriza el BOE, DOUE y
  boletines autonómicos para detectar cambios normativos relevantes. Filtra
  por sector y umbral de materialidad configurados. Genera un digest con
  evaluación de relevancia. Usar para configurar o ejecutar bajo demanda
  diciendo "alertas regulatorias", "¿hay novedades?", "digest normativo".
...
El entorno regulatorio español es denso y fragmentado: BOE, DOUE, boletines autonómicos, circulares sectoriales, guías de autoridades. Perderse una norma relevante es un riesgo real. Este skill actúa como filtro inteligente: monitoriza las fuentes, evalúa la relevancia para la organización y genera un digest con solo lo que importa.
...
|---|---|---|---|
| **BOE** | boe.es | Legislación estatal | Diaria |
| **DOUE** | eur-lex.europa.eu | Legislación UE | Diaria |
| **BOJA / DOGC / BOCM / etc.** | [autonómico] | Legislación autonómica | Según config |
| **AEPD** | aepd.es | Resoluciones, guías | Semanal |
| **CNMV** | cnmv.es | Circulares, comunicados | Semanal |
| **Banco de España** | bde.es | Circulares | Semanal |
| **CNMC** | cnmc.es | Resoluciones | Semanal |
...
| Campo | Detalle |
|---|---|
| **Referencia** | [rango, número, fecha, fuente] |
| **Publicación** | [BOE/DOUE/autonómico — fecha] |
...
- Constitución Española art. 9.3 (publicidad de normas)
- Código Civil art. 2.1 (entrada en vigor: 20 días tras publicación BOE salvo disposición contraria)
- Normativa sectorial según configuración
