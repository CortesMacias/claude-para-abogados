...
```
/regulatorio:diff
Se ha publicado el Real Decreto X/2026 que modifica los requisitos de
información precontractual en el sector financiero.
```
...
| Campo | Contenido |
|---|---|
| **Norma / Guía** | [referencia completa: rango, número, fecha, BOE/DOUE] |
| **Tipo de cambio** | [Nueva norma / Reforma / Derogación / Guía interpretativa / Circular] |
| **Fecha de publicación** | [fecha] |
| **Entrada en vigor** | [fecha — inmediata o con vacatio legis] |
| **Período transitorio** | [si existe — duración y condiciones] |
| **Ámbito** | [sectorial / transversal; territorial: estatal / autonómico / UE] |
...
- Normativa sectorial según el perfil de práctica configurado
- Constitución Española art. 9.3 (principio de publicidad de las normas)
- Código Civil art. 2 (entrada en vigor de las leyes)
