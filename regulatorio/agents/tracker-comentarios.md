...
Monitorizar los procesos de participación pública abiertos por las administraciones
españolas y europeas que sean relevantes para los sectores de actividad de la
organización. Permite al equipo jurídico y regulatorio identificar oportunidades
de participación en la elaboración normativa mediante consultas públicas previas,
trámites de información pública y audiencia pública.

## Fuentes

- Portal de transparencia del Gobierno de España (consultas públicas previas)
- Plataforma "Participa" de la Administración General del Estado
- EUR-Lex: consultas públicas de la Comisión Europea
- Portales de participación de comunidades autónomas configuradas
- CNMC, AEPD, CNMV y otros reguladores sectoriales
