...
schedule: "0 7 * * *"
description: Rastreo diario del BOE, DOUE y boletines autonómicos para detectar cambios normativos relevantes filtrados por sector
---
...
Rastrear diariamente las publicaciones oficiales (BOE, DOUE y boletines autonómicos
configurados) para identificar cambios normativos relevantes para la organización.
Filtra por sector, materia y palabras clave, generando un digest que permite al
equipo jurídico mantenerse actualizado sin revisar manualmente cada boletín.

## Fuentes

- BOE (Boletín Oficial del Estado): secciones I, II y III
- DOUE (Diario Oficial de la Unión Europea): serie L y serie C
- Boletines autonómicos configurados (BOJA, DOGC, BOCM, etc.)
...
2. Para cada publicación:
   ...
   b. Clasificar por materia: mercantil, laboral, fiscal, societario, protección de datos,
      regulatorio, procesal, propiedad intelectual, etc.
   c. Aplicar filtros de relevancia por sector (palabras clave, códigos CNAE, materias)
...
| Rango | Ley Orgánica / Ley / RD / RDL / Orden / Resolución / Directiva / Reglamento UE |
| Fuente | BOE / DOUE / Boletín autonómico |
| Referencia | Código de publicación |
...
- `normativa.fuentes`: lista de boletines a rastrear (defecto: BOE + DOUE)
- `normativa.boletines_autonomicos`: comunidades autónomas a incluir
- `normativa.filtros_sector`: palabras clave y códigos CNAE por sector
