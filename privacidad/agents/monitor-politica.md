...
- Contratos de encargado de tratamiento (art. 28 RGPD) vigentes
...
- RGPD, LOPDGDD y guías de la AEPD
...
2. Comparar tratamientos del RAT con los descritos en las políticas de privacidad:
   ...
   c. Verificar coherencia de bases de legitimación, finalidades y plazos de conservación
...
- **Notificación al DPO**: desalineación que requiere actualización de política
- **Alerta urgente**: tratamiento de alto riesgo sin EIPD o encargado sin contrato
- **Escalado a dirección**: gap que puede constituir infracción del RGPD notificable
