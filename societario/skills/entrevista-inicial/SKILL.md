...
description: >
  ...
  tipos de sociedad que manejas, tus áreas activas (M&A, secretaría del consejo,
...
3. Documentos semilla: actas, informes de due diligence, cuentas anuales.
...
La práctica societaria en España abarca desde la constitución de una SL de un euro hasta la gestión del consejo de una cotizada. Un secretario del consejo vive en actas y certificaciones. Un abogado de M&A vive en due diligence y operaciones corporativas. Un gestor de entidades vive en el Registro Mercantil y las cuentas anuales. Esta entrevista descubre qué áreas son las tuyas y construye solo el perfil relevante.
...
> **`societario` es para quienes trabajan en derecho de sociedades — constituciones, M&A, secretaría del consejo, cumplimiento registral y gestión de entidades.** ¿No es tu área? `/legal-builder-hub:related-skills-surfacer`.
>
...
**Verificar hechos jurídicos.** Comprobar citas de artículos (LSC, RRM, CC) antes de escribirlas en la configuración.
...
> Este plugin puede trabajar con: Registro Mercantil online, almacenamiento de documentos (Google Drive, SharePoint, Box), herramientas de firma (Docusign, Signaturit) y Slack.
...
- **Tipos societarios que manejas:** ¿cuáles de estos?
  ...
  - Cooperativas
  - Otros (sociedad civil, comanditaria, agrupaciones de interés económico)
...
>
> 1. **M&A** — compraventas de participaciones/acciones, fusiones, escisiones, aportaciones no dinerarias.
> 2. **Secretaría del consejo** — actas, certificaciones, convocatorias, libros societarios.
> 3. **Cumplimiento registral** — cuentas anuales, nombramientos, modificaciones estatutarias, depósito de cuentas.
> 4. **Gestión de entidades** — estructura de grupo, constituciones, disoluciones, operaciones societarias de reestructuración.
...
- **Umbrales de materialidad:** ¿cuándo algo es material? (Todos los contratos / >X euros / top N por facturación)
...
### Parte 4: Gobierno corporativo (4-5 min, si secretaría del consejo activo)
...
- **¿Quién certifica?** (Secretario, secretario no consejero, vicesecretario)
- **¿Legitimación de firma notarial habitual?**

#### Libros societarios

- **¿Libros legalizados en el Registro Mercantil?** ¿Al día?
- **Formato:** ¿digital (Legalización telemática) o físico?
- **¿Quién los mantiene?** (Secretario, despacho externo, gestoría)

> Sube 2-3 actas anteriores de juntas o consejos cerrados — nada activo. Quiero ver tu formato house: estructura, nivel de detalle, cómo redactas los acuerdos, cómo registras la asistencia.
...
> - **Cuentas anuales** depositadas (memoria, balance, PyG)
...
*Escrito por entrevista-inicial el [FECHA]. Áreas activas: [M&A | Secretaría del consejo | Cumplimiento registral | Gestión de entidades]*
...
|---|---|---|
| M&A | [activa/inactiva] | |
| Secretaría del consejo | [activa/inactiva] | |
...
**Libros societarios:** [PLACEHOLDER]
...
> - **Redactar actas del consejo o junta** — en tu formato house, con el nivel de detalle que usas. Prueba: `/societario:actas`
> - **Certificaciones del secretario** — desde plantillas aprendidas de tus documentos. Prueba: `/societario:certificacion`
> - **Calendario de cumplimiento registral** — qué hay que depositar y cuándo. Prueba: `/societario:cumplimiento-registral`
>
...
- **No asumas que todas las áreas están activas.** Un abogado de M&A no necesita configurar secretaría del consejo.
- **No confundas tipos societarios.** Una SL y una SA tienen regímenes diferentes en la LSC. No mezcles.
- **No escribas formatos genéricos de actas.** Si el usuario te dio actas semilla, extrae su formato exacto.
- **No asumas régimen registral.** El RRM tiene plazos y requisitos específicos — verifica antes de escribir.
