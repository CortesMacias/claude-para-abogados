...
|---|---|---|
| CLM (Bigle Legal, Signaturit, etc.) | [PLACEHOLDER ✓/✗] | Registro manual; el rastreador de renovaciones funciona con registro local |
| Firma electrónica (Signaturit, DocuSign, VIDsigner) | [PLACEHOLDER ✓/✗] | El usuario gestiona la firma fuera del plugin |
...
**Cap directo (múltiplo de honorarios/precio):** [PLACEHOLDER — ej., "12 meses de importes facturados o por facturar"]
...
**Posición estándar:** [PLACEHOLDER — ej., "Nuestro contrato de encargado del tratamiento (art. 28 RGPD); el cliente firma como responsable"]

**Requisitos:**
- [PLACEHOLDER — ej., "Registro de actividades de tratamiento, evaluación de impacto si aplica, cláusulas contractuales tipo para transferencias internacionales"]
...
**Resolución anticipada:** [PLACEHOLDER — ej., "Por incumplimiento esencial con plazo de subsanación de 30 días; por insolvencia art. 5 bis LC"]
...
**Preferida:** [PLACEHOLDER — ej., "Ley española, Juzgados de Madrid"]
**Aceptable:** [PLACEHOLDER — ej., "Ley española, Juzgados de Barcelona"]
**Escalar:** [PLACEHOLDER — ej., "Ley de un Estado miembro UE, arbitraje institucional"]
**Nunca:** [PLACEHOLDER — ej., "Jurisdicción no UE sin convenio de reconocimiento"]
...
**Requisitos:**
- [PLACEHOLDER — ej., "Certificación ENS si aplica, auditoría anual, notificación de brechas en 24h"]
...
**Umbrales por importe:** [PLACEHOLDER — ej., "<50K€ paralegal; 50-200K€ abogado; >200K€ responsable jurídico"]
...
**Citas normativas:** [PLACEHOLDER — ej., "Formato: art. 1101 CC, art. 325 CdC, art. 1 LSSI-CE"]
...
|---|---|---|
| 🟢 Verde | [PLACEHOLDER — ej., "NDA mutuo estándar, duración ≤3 años, ley española, sin cláusula penal desproporcionada"] | Firmar sin revisión adicional |
| 🟡 Amarillo | [PLACEHOLDER — ej., "NDA unilateral, ley extranjera UE, non-solicit, cláusula penal"] | Revisar y proponer cambios |
| 🔴 Rojo | [PLACEHOLDER — ej., "Ley no UE, cesión de PI en NDA, indemnización ilimitada, duración perpetua"] | Escalar a responsable jurídico |

**Posiciones específicas para NDAs:**
- **Duración de confidencialidad:** [PLACEHOLDER — ej., "Máximo 3 años; 5 años para secretos empresariales (Ley 1/2019)"]
...
- **Código de Comercio** (Real Decreto de 22 de agosto de 1885) — contratos mercantiles, obligaciones del comerciante
- **Código Civil** arts. 1254-1314 — teoría general de obligaciones y contratos (aplicación supletoria)
- **LSSI-CE** (Ley 34/2002, de 11 de julio) — servicios de la sociedad de la información y comercio electrónico
- **Ley de Condiciones Generales de la Contratación** (Ley 7/1998, de 13 de abril) — control de inclusión y contenido
- **RGPD** (Reglamento UE 2016/679) y **LOPDGDD** (LO 3/2018) — en lo relativo a cláusulas de protección de datos en contratos
- **Ley de Secretos Empresariales** (Ley 1/2019) — confidencialidad y secreto empresarial
- **Ley de Patentes** (Ley 24/2015) y **Ley de Marcas** (Ley 17/2001) — en lo relativo a cláusulas de PI
