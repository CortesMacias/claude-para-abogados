...
|---|---|---|---|
| Definición | Concepto | Definición + artículo | "Contrato de compraventa" → "Art. 1445 CC: ..." |
| Artículo | N.o de artículo | Contenido esencial | "Art. 1902 CC" → "Responsabilidad extracontractual: ..." |
| Regla | Enunciado de la regla | Explicación + excepciones | "Plazo de prescripción general civil" → "5 años (art. 1964 CC)" |
...
fichas:
  - id: F-001
    ...
    dorso: "Art. 1445 CC: Por el contrato de compraventa uno de los contratantes se obliga a entregar una cosa determinada y el otro a pagar por ella un precio cierto."
    caja: 1
    sesiones_en_caja: 0
...
- **Adaptar al nivel.** Fichas de primer año de derecho civil son distintas de fichas para oposiciones.
